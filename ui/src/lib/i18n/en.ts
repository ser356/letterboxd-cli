...
export const en: Record<string, string> = {
  ...
  'nav.session': 'Session',
  'nav.logout': 'Log out',
  'nav.shuffle': 'Roll the dice',

  // ── Shuffle (atmospheric dice, Filmin-style) ──────────
  'shuffle.title': 'Pick for me',
  'shuffle.subtitle': 'Four quick questions and I hand you a film.',
  'shuffle.step': 'Step {{n}} of {{total}}',
  'shuffle.next': 'Next',
  'shuffle.roll': 'Roll the dice',
  'shuffle.retry': 'Roll again',
  'shuffle.rolling': 'Shuffling the catalog…',
  'shuffle.empty': 'Nothing fits those vibes. Try loosening a filter.',
  'shuffle.play': 'Watch it',
  'shuffle.close': 'Close',
  'shuffle.q.mood': 'What do you feel like tonight?',
  'shuffle.mood.laugh': 'A proper laugh',
  'shuffle.mood.cry': 'Feel some feelings',
  'shuffle.mood.rush': 'Pure adrenaline',
  'shuffle.mood.scare': 'Get scared',
  'shuffle.mood.escape': 'Escape to another world',
  'shuffle.mood.romance': 'Something with heart',
  'shuffle.mood.mystery': 'A puzzle to crack',
  'shuffle.mood.surprise': 'Surprise me',
  'shuffle.q.company': 'Who are you watching with?',
  'shuffle.company.alone': 'On my own',
  'shuffle.company.couple': 'A date',
  'shuffle.company.friends': 'With friends',
  'shuffle.company.family': 'With family',
  'shuffle.q.duration': 'How much time do you have?',
  'shuffle.duration.short': 'A short one',
  'shuffle.duration.medium': 'A full evening',
  'shuffle.duration.long': 'No rush',
  'shuffle.duration.any': "Doesn't matter",
  'shuffle.q.era': 'Fresh or classic?',
  'shuffle.era.new': 'Just released',
  'shuffle.era.modern': 'This century',
  'shuffle.era.classic': 'A classic',
  'shuffle.era.any': 'Surprise me',
