...
export const es: Record<string, string> = {
  ...
  'nav.shuffle': 'Tira el dado',

  // ── Shuffle (dado atmosférico, estilo Filmin) ─────────
  'shuffle.title': 'Elige por ti',
  'shuffle.subtitle': 'Contéstame cuatro cosas y te propongo peli.',
  'shuffle.step': 'Paso {{n}} de {{total}}',
  'shuffle.next': 'Siguiente',
  'shuffle.roll': 'Tirar el dado',
  'shuffle.retry': 'Otra tirada',
  'shuffle.rolling': 'Barajando el catálogo…',
  'shuffle.empty': 'Con esos gustos no encontré nada. Prueba a aflojar algún filtro.',
  'shuffle.play': 'Verla',
  'shuffle.close': 'Cerrar',
  'shuffle.q.mood': '¿Qué te apetece esta noche?',
  'shuffle.mood.laugh': 'Reírme mucho',
  'shuffle.mood.cry': 'Sentir cosas',
  'shuffle.mood.rush': 'Adrenalina pura',
  'shuffle.mood.scare': 'Pasar miedo',
  'shuffle.mood.escape': 'Escapar a otro mundo',
  'shuffle.mood.romance': 'Algo de corazón',
  'shuffle.mood.mystery': 'Un enigma que resolver',
  'shuffle.mood.surprise': 'Sorpréndeme',
  'shuffle.q.company': '¿Con quién la vas a ver?',
  'shuffle.company.alone': 'Sola / solo',
  'shuffle.company.couple': 'En pareja',
  'shuffle.company.friends': 'Con amigos',
  'shuffle.company.family': 'En familia',
  'shuffle.q.duration': '¿Cuánto rato tienes?',
  'shuffle.duration.short': 'Un ratito',
  'shuffle.duration.medium': 'Una tarde entera',
  'shuffle.duration.long': 'No tengo prisa',
  'shuffle.duration.any': 'Da igual',
  'shuffle.q.era': '¿Novedad o clásico?',
  'shuffle.era.new': 'Recién estrenada',
  'shuffle.era.modern': 'De este siglo',
  'shuffle.era.classic': 'Un clásico',
  'shuffle.era.any': 'Sorpréndeme',
  ...
  'menu.noActions': 'No hay acciones a realizar',
